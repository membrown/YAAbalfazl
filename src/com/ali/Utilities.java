...
public class Utilities {
    ...
    private class SolarCalendar {
        ...
        public SolarCalendar(int days) {
            Calendar MiladiDate = GregorianCalendar.getInstance();
            MiladiDate.add(Calendar.DAY_OF_YEAR,days);
    ...
    public static String getCurrentShamsidate(int days) {
        Locale loc = new Locale("en_US");
        Utilities util = new Utilities();
        SolarCalendar sc = util.new SolarCalendar(days);
